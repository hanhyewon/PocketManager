            ...
            case android.R.id.home : //왼쪽 메뉴 버튼을 눌렀을 때
                ...
                logoutBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        finish();
                        Intent intent = new Intent(OrderRegisterActivity.this, MainActivity.class);
                ...
                salesManagerBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        finish();
                        Intent intent = new Intent(OrderRegisterActivity.this, SalesManagerMainActivity.class);
                        startActivity(intent);
                    }
                });
                ...
                moneyTotalManagerBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        finish();
                        Intent intent = new Intent(OrderRegisterActivity.this, pastSalesMode.class);
                        startActivity(intent);
                    }
                });
        }
